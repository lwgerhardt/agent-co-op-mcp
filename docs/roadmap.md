...
5. ~~Verification CLI runner → publish-for-verifier → MCP tools~~ (shipped — #18, #20, #46)
6. ~~Multi-agent workflow docs~~ (shipped — #47)
7. Transcript-assisted capture (#24)
8. Multi-project registry + bootstrap CLI (#44, #45)
9. v2 manifest workflow fields in role prompts (read_map, bootstrap, role notes)
